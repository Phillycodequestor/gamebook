...
statement[4] = new falseStatement("Donald Trump: How low has President Obama gone to tap my phones during the very sacred election process. This is Nixon/Watergate. Bad (or sick) guy!","This claim was based on news reports that in October the Foreign Intelligence Surveillance Court issued a warrant after evidence was presented of a server, possibly related to the Trump campaign, with alleged links to two Russian banks. Neither Trump nor his associates are named in the FISA order, which would only cover foreign citizens or entities. A president has no role in the FBI's decision to seek a warrant.",false);
